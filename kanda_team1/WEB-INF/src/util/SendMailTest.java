...
public class SendMailTest {
	...
	public static void mailBuy(String sentens,String mailAddress) {
		try {

			String mailSentens=sentens;
			...
			// メールのタイトルを指定
			mimeMessage.setSubject("購入通知", "iso-2022-jp");

			// メールの内容を指定
			mimeMessage.setText(mailSentens, "iso-2022-jp");
