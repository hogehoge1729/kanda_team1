...
<body>
	...
	<br><a href="<%=context %>/purchaseCompletion?sell_id=<%= sellDto.getSellId() %>&seller=<%= seller.getMail() %>">購入</a>
	<br><a href="<%=context %>/ReportServlet?sellerId=<%= sellDto.getSellerMemberId() %>">通報/報告</a>
